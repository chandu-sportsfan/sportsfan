...
export default function Team360ViewPage({
    params,
}: {
    ...
    const fetchPost = async () => {
      const res = await axios.get(`/api/team360/${id}`);
    ...
    const handleEdit = () => {
        router.push(
            `/admin/team360-management/add-team360?id=${id}`
        );
    };
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            router.push("/team360-management/team360-list");
        } catch (error) {
    ...
    return (
        <div className="max-w-[1200px] mx-auto p-6 text-white">
            ...
            <div className="bg-[#161b22] rounded-lg p-6 space-y-3">
                <p><b>Team Name:</b> {post.teamName}</p>
