...
//         <p style={{ color: "#7d8590", fontSize: 12, marginTop: 2 }}>Real-time snapshot — March 2026</p>
//       </div>
...
//                 <div key={m} style={{ flex: 1, textAlign: "center", fontSize: 10, color: "#7d8590", fontFamily: "var(--font-mono)" }}>{m}</div>
//               ))}
//             </div>
//           </div>
//         </TableWrap>
...
//         <TableWrap>
//           <TableToolbar><div style={{ fontSize: 13, fontWeight: 600 }}>Recent Activity</div></TableToolbar>
...
//             ].map((ev, i) => (
//               <div key={i} style={{ display: "flex", gap: 10, padding: "10px 0", borderBottom: i < 4 ? "1px solid #21282f" : "none" }}>
...
//             ].map((u, i) => (
//               <tr key={i} style={{ borderBottom: i < 2 ? "1px solid #21282f" : "none" }}>
//                 <td style={{ padding: "9px 14px" }}><UserCell name={u.name} email={u.email} index={i} /></td>
//                 <td style={{ padding: "9px 14px", fontFamily: "var(--font-mono)", fontSize: 12 }}>{u.date}</td>
//                 <td style={{ padding: "9px 14px" }}><Badge variant="blue">OTP</Badge></td>
//                 <td style={{ padding: "9px 14px" }}>
//                   <Badge variant={u.status === "Active" ? "green" : "yellow"} dot>{u.status}</Badge>
//                 </td>
//               </tr>
//             ))}
//           </tbody>
...
// // ════════════════════════════════════════════════════════
// // "use client";
// // import { StatCard, TableWrap, TableToolbar, Badge, UserCell, SearchInput, Btn, Pagination } from "@/components/admin/ui";
// //
// // const USERS = [
// //   { name: "Ravi Kumar",      email: "ravi.k@gmail.com",    phone: "+91 98765 43210", role: "Admin",     joined: "22 Mar 2026", lastLogin: "Today, 09:42", status: "Active"    },
// //   { name: "Priya Sharma",    email: "priya.s@yahoo.com",   phone: "+91 91234 56789", role: "User",      joined: "21 Mar 2026", lastLogin: "Yesterday",    status: "Active"    },
// //   { name: "Arjun Mehta",     email: "arjun.m@outlook.com", phone: "+91 87654 32109", role: "User",      joined: "21 Mar 2026", lastLogin: "21 Mar",       status: "Pending"   },
// //   { name: "Deepa Nair",      email: "deepa.n@gmail.com",   phone: "+91 99887 76655", role: "User",      joined: "18 Mar 2026", lastLogin: "19 Mar",       status: "Suspended" },
// //   { name: "Suresh Krishnan", email: "suresh.k@gmail.com",  phone: "+91 88112 23344", role: "Moderator", joined: "15 Mar 2026", lastLogin: "Today, 08:10", status: "Active"    },
// // ];
// //
// // const ROLE_VARIANT: Record<string, "blue"|"green"|"yellow"> = { Admin: "blue", User: "green", Moderator: "yellow" };
// // const STATUS_VARIANT: Record<string, "green"|"yellow"|"red"> = { Active: "green", Pending: "yellow", Suspended: "red" };
// //
...
// //         <p style={{ color: "#7d8590", fontSize: 12, marginTop: 2 }}>Manage registered users, roles and access</p>
// //       </div>
// //       <TableWrap>
// //         <TableToolbar>
// //           <SearchInput placeholder="Search users…" />
// //           <select style={{ background: "#0d1117", border: "1px solid #2d3748", borderRadius: 6, padding: "5px 8px", color: "#e6edf3", fontSize: 12, width: 130 }}>
// //             <option>All roles</option><option>Admin</option><option>User</option><option>Moderator</option>
// //           </select>
// //           <div style={{ marginLeft: "auto", display: "flex", gap: 8 }}>
// //             <Btn variant="ghost" sm>Export CSV</Btn>
// //             <Btn variant="primary" sm>+ Invite User</Btn>
// //           </div>
// //         </TableToolbar>
// //         <table style={{ width: "100%", borderCollapse: "collapse" }}>
// //           <thead>
// //             <tr style={{ background: "#1c2330", borderBottom: "1px solid #21282f" }}>
// //               {["","User","Phone","Role","Joined","Last Login","Status",""].map((h,i) => (
// //                 <th key={i} style={{ textAlign: "left", padding: "8px 14px", fontSize: 10, fontWeight: 600, letterSpacing: ".07em", textTransform: "uppercase", color: "#7d8590" }}>{h}</th>
// //               ))}
// //             </tr>
// //           </thead>
// //           <tbody>
// //             {USERS.map((u, i) => (
// //               <tr key={i} style={{ borderBottom: i < USERS.length-1 ? "1px solid #21282f" : "none" }}>
// //                 <td style={{ padding: "9px 14px" }}><input type="checkbox" /></td>
// //                 <td style={{ padding: "9px 14px" }}><UserCell name={u.name} email={u.email} index={i} /></td>
// //                 <td style={{ padding: "9px 14px", fontFamily: "var(--font-mono)", fontSize: 12 }}>{u.phone}</td>
// //                 <td style={{ padding: "9px 14px" }}><Badge variant={ROLE_VARIANT[u.role] ?? "blue"}>{u.role}</Badge></td>
// //                 <td style={{ padding: "9px 14px", fontFamily: "var(--font-mono)", fontSize: 12 }}>{u.joined}</td>
// //                 <td style={{ padding: "9px 14px", fontFamily: "var(--font-mono)", fontSize: 12 }}>{u.lastLogin}</td>
// //                 <td style={{ padding: "9px 14px" }}><Badge variant={STATUS_VARIANT[u.status]} dot>{u.status}</Badge></td>
// //                 <td style={{ padding: "9px 14px" }}><Btn sm>Edit</Btn></td>
// //               </tr>
// //             ))}
// //           </tbody>
// //         </table>
// //         <Pagination total={1284} page={1} />
// //       </TableWrap>
// //     </div>
// //   );
// // }
