...
//         const matchId = params instanceof Promise ? (await params).matchId : params.id;
...
//     } catch (error) {
//         console.error("[predictions GET] Error details:", error);
...
//                 // Optional: include error type for debugging (remove in production)
